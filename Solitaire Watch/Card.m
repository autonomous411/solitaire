...
-(id) initWithSuit:(NSString*) suit value:(NSInteger) value filename:(NSString*) filename color:(NSString*) color andIndex:(NSInteger)index is42:(BOOL) is42 isCopy:(BOOL) isCopy
{
    ...
    if (self)
    {
        ...
        else
        {
            ...
            {
                self.filename = [filename stringByReplacingOccurrencesOfString:@".png" withString:[NSString stringWithFormat:@"_44mm%@.png",[self.sharedDefaults objectForKey:@"cardskin"]]];//@"_38mm.png"];
            }
        }
