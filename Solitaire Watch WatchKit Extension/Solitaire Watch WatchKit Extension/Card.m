...
-(id) initWithSuit:(NSString*) suit value:(NSInteger) value filename:(NSString*) filename color:(NSString*) color andIndex:(NSInteger)index is42:(BOOL) is42 isCopy:(BOOL) isCopy
{
    ...
    if (self)
    {
        ...
        else
        {
            ...
            if (self.is42)
            {
                self.filename = [filename stringByReplacingOccurrencesOfString:@".png" withString:@"_44mm.png"];
            }
            else
            {
                self.filename = [filename stringByReplacingOccurrencesOfString:@".png" withString:@"_38mm.png"];
            }
        }
